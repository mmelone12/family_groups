            ...
            pages.each do |enter|
              ...
              agent.page.search(".event").each do |activity|
                ...
                if title.present?                       
                  ...
                  :user_id => user_id).first_or_create(:start_date => start_date, :when => total_date, :desc => desc, :address => address, 
                    :article_link => article_link, :recurring => recurring,
                  :user_id => user_id)
      ...
      City.all.each do |city|
            ...
            agent.page.search(".title").each do |group|
                  ...
                  if res.code == "200"
                    ...
                    if month.chars.count == 3 && day.present? && start_time.present?
