...
task :fetch_redtri => :environment do
  require 'mechanize'
            ...
            page = agent.get("http://redtri.com/events/los-angeles/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
            ...
            page = agent.get("http://redtri.com/events/atlanta/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
            ...
            page = agent.get("http://redtri.com/events/chicago/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
            ...
            page = agent.get("http://redtri.com/events/new-york/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
            ...
            page = agent.get("http://redtri.com/events/portland/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
             ...
             page = agent.get("http://redtri.com/events/seattle/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
             ...
             page = agent.get("http://redtri.com/events/socal/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
             ...
             page = agent.get("http://redtri.com/events/dc/")
            agent.page.search(".event").each do |activity|
                article_link = activity.search("a").first.to_s[/(http[^"]+\w)/]
                title = activity.search("h2 a").text.strip
                cost = activity.search("span")[5].text.strip
